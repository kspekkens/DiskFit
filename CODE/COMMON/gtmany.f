...
c
      ...
      ic = 0
    1 ic = ic + 1
      if( ic .gt. 10 )call crash( 'GTCHAR', 'Too many tries' )
      if( n .gt. 9 )then
        a = '(a00)'
        write( a( 3:4 ), '( i2 )' )n
...
c find number of non-blank characters
      ...
      ic = 0
    1 ic = ic + 1
      if( ic .gt. 10 )call crash( 'GTINTG', 'Too many tries' )
      print '( a )', prompt( 1:n )
      read( *, *, err = 1 )i
      return
      end
...
c find number of non-blank characters
      ...
      ic = 0
    1 ic = ic + 1
      if( ic .gt. 10 )call crash( 'GTINTGS', 'Too many tries' )
      print '( a )', prompt( 1:j )
      read( *, *, err = 1 )i
      return
      end
...
c
      ic = 0
    1 ic = ic + 1
      if( ic .gt. 10 )call crash( 'GTREAL', 'Too many tries' )
      print '( a )', prompt( 1:n )
      read( *, *, err = 1 )f
      return
      end
...
c
      ic = 0
    1 ic = ic + 1
      if( ic .gt. 10 )call crash( 'GTREALS', 'Too many tries' )
      print '( a )', prompt( 1:i )
      read( *, *, err = 1 )f
      return
      end
...
c find number of non-blank characters
      ...
      ic = 0
    1 ic = ic + 1
      if( ic .gt. 10 )call crash( 'GTDBLE', 'Too many tries' )
      print '( a )', prompt( 1:n )
      read( *, *, err = 1 )f
      return
      end
